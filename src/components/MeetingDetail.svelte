...
<div class="mx-auto max-w-2xl px-4 py-6">
  ...
  <div class="mb-4">
    {#if meeting.isInPerson}
      <span class="bmlt-badge-in-person inline-flex items-center gap-1 rounded-full bg-green-100 px-2.5 py-1 text-sm font-medium text-green-700">{$t.inPerson}</span>
    {/if}
    {#if meeting.isVirtual}
      <span class="bmlt-badge-virtual inline-flex items-center gap-1 rounded-full bg-blue-100 px-2.5 py-1 text-sm font-medium text-blue-700">{$t.virtual}</span>
    {/if}
  </div>
  ...
  <div class="space-y-4">
    ...
    {#if meeting.resolvedFormats.length > 0}
      <div class="bmlt-card rounded-lg border border-gray-200 p-4">
        <h3 class="mb-2 text-sm font-semibold text-gray-700">{$t.meetingFormats}</h3>
    ...
    {#if meeting.comments}
      <div class="bmlt-card rounded-lg border border-gray-200 p-4">
        <h3 class="mb-2 text-sm font-semibold text-gray-700">{$t.notes}</h3>
    ...
    {#if meeting.email_contact}
      <div class="bmlt-card rounded-lg border border-gray-200 p-4">
        <h3 class="mb-2 text-sm font-semibold text-gray-700">{$t.contact}</h3>
