...
<div bind:this={el} class="relative inline-block">
  <button onclick={toggle} aria-expanded={open} class="bmlt-btn-secondary inline-flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-sm font-medium transition-colors">
