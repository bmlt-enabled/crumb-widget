export const frTranslations = {
  ...
  searchLocation: 'Ville, code postal ou adresse...',
  searchModeFilter: 'Filtrer les réunions',
  searchModeLocation: 'Rechercher un lieu',
  ...
  evening: 'Soirée',
  night: 'Nuit',
  locked: 'verrouillé par la configuration du site',
  // Meeting list
  ...
  schedule: 'Horaire',
  meetingLocalTime: 'Heure locale de la réunion',
  at: 'à',
  duration: 'Durée',
