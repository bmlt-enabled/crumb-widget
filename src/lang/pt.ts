export const ptTranslations = {
  ...
  evening: 'Noite',
  night: 'Madrugada',
  locked: 'bloqueado pela configuração do site',
  // Meeting list
  ...
  schedule: 'Horário',
  meetingLocalTime: 'Horário local da reunião',
  at: 'às',
  duration: 'Duração',
  ...
  // Errors
  errorNoServer: 'Nenhum URL de servidor configurado. Adicione data-server ao seu elemento de incorporação.',
  errorLoadingMeetings: 'Falha ao carregar as reuniões.',
  // Map
