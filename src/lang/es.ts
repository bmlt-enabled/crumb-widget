export const esTranslations = {
  ...
  searchLocation: 'Ciudad, código postal o dirección...',
  searchModeFilter: 'Filtrar reuniones',
  searchModeLocation: 'Buscar ubicación',
  locationNotFound: 'No se pudo encontrar esa ubicación',
  filters: 'Filtros',
  day: 'Día',
  ...
  evening: 'Noche',
  night: 'Madrugada',
  locked: 'bloqueado por la configuración del sitio',
  // Meeting list
  ...
  schedule: 'Horario',
  meetingLocalTime: 'Hora local de la reunión',
  at: 'a las',
  duration: 'Duración',
  ...
  // Errors
  errorNoServer: 'No hay una URL de servidor configurada. Añada data-server a su elemento de inserción.',
  errorLoadingMeetings: 'No se pudieron cargar las reuniones.',
  // Map
