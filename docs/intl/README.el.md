...
- Προαιρετικός σύνδεσμος «Ενημέρωση πληροφοριών συνάντησης» σε κάθε λεπτομέρεια συνάντησης — οδηγεί σε φόρμα [bmlt-workflow](https://github.com/bmlt-enabled/bmlt-workflow), σε οποιαδήποτε προσαρμοσμένη φόρμα ή σε URL `mailto:` ([τεκμηρίωση](https://crumb.bmlt.app/?lang=el#update-url))
