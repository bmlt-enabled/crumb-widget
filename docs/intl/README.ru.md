...
- Необязательная ссылка «Обновить информацию о собрании» в деталях каждого собрания — указывает на форму [bmlt-workflow](https://github.com/bmlt-enabled/bmlt-workflow), любую пользовательскую форму или URL `mailto:` ([документация](https://crumb.bmlt.app/?lang=ru#update-url))
